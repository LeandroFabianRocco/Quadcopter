# Controlling a Quadcopter using FRDM-K64F and MPU6050 Accel/Gyro
...
![Aquí la descripción de la imagen por si no carga](https://github.com/leandroGHsoft/BLDCMotorControl/blob/master/images/motor.jpg)

and the ESC controller is:

![Aquí la descripción de la imagen por si no carga](https://github.com/leandroGHsoft/BLDCMotorControl/blob/master/images/esc.jpg)

The FRDM-K64F board is from NXP and is shown in the next figure:

![Aquí la descripción de la imagen por si no carga](https://github.com/leandroGHsoft/BLDCMotorControl/blob/master/images/frdm-k64f.jpg)
